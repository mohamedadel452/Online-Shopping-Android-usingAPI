...
public class Allelctronecproduct extends AppCompatActivity {
    TextView textView;
    RecyclerView myRecycler;
    ViewModle productViewModel;
    SearchView searchView;
    ProgressDialog progressDialog;
    ElctronesAdpter productCAstomadapteer;
    ImageView back;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_allelctronecproduct);

       back=findViewById(R.id.arrow_back);
       back.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View v) {
               startActivity(new Intent(Allelctronecproduct.this,Home.class));
           }
       });
...
//        GridLayoutManager gridLayoutManager=new GridLayoutManager(this,2);
        ...
        productViewModel.getelectronics(this).observe(this, heroModels -> {
            productCAstomadapteer = new ElctronesAdpter(Allelctronecproduct.this,heroModels);
