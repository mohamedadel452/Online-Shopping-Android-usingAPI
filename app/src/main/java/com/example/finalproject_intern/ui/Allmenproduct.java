...
public class Allmenproduct extends AppCompatActivity {
    TextView textView;
    RecyclerView myRecycler;
    ViewModle productViewModel;
    SearchView searchView;
    ProgressDialog progressDialog;
    MensAdapter productCAstomadapteer;
    ImageView back;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_allmenproduct);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Allmenproduct.this,Home.class));
            }
        });
...
//        GridLayoutManager gridLayoutManager=new GridLayoutManager(this,2);
        ...
        productViewModel.getmensproduct(this).observe(this, heroModels -> {
            productCAstomadapteer = new MensAdapter(Allmenproduct.this,heroModels);
