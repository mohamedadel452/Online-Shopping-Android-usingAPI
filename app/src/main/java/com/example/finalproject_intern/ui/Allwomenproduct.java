...
public class Allwomenproduct extends AppCompatActivity {
    TextView textView;
    RecyclerView myRecycler;
    ViewModle productViewModel;
    SearchView searchView;
    ProgressDialog progressDialog;
    WomenAdapter productCAstomadapteer;
    ImageView back;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_allwomenproduct);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Allwomenproduct.this,Home.class));
            }
        });
...
//        GridLayoutManager gridLayoutManager=new GridLayoutManager(this,2);
        ...
        productViewModel.getwomenproduct(this).observe(this, heroModels -> {
            productCAstomadapteer = new WomenAdapter(Allwomenproduct.this,heroModels);
