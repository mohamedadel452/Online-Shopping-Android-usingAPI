...
public class SearchActivity extends AppCompatActivity {
    ...
    ProductCAstomadapter productCAstomadapteer;
    ImageView back;
    @Override
...
//        GridLayoutManager gridLayoutManager=new GridLayoutManager(this,2);
        ...
        productViewModel.getproduct(this).observe(this, heroModels -> {
            productCAstomadapteer = new ProductCAstomadapter(SearchActivity.this,heroModels);
