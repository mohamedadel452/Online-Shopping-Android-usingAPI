...
public class ElctronesAdpter  extends RecyclerView.Adapter<ProductCAstomadapter.MyViewHolder> implements Filterable {
    ...
    public ElctronesAdpter(Context ctx, List<ProductModel> heroList) {
        this.ctx = ctx;
...
//                .load( "https://api.lorem.space/image/furniture?w=640&h=480&r=9470")
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ctx, productelctronesactivety.class);
