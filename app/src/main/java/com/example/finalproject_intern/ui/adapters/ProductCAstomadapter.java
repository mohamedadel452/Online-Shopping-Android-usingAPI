...
public class ProductCAstomadapter extends RecyclerView.Adapter<ProductCAstomadapter.MyViewHolder> implements Filterable {

    Context ctx;
    List<ProductModel> prodList;
    List<ProductModel> prodListsearch;

    public ProductCAstomadapter(Context ctx, List<ProductModel> heroList) {
        this.ctx = ctx;
    ...
    public ProductCAstomadapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View recyclerView = inflater.inflate(R.layout.cardofproduct2,parent,false);
...
//
//                Intent intent = new Intent(ctx, ProductdetailsActivites.class);
//                 int i = holder.getAdapterPosition();
//                intent.putExtra("pos",holder.getAdapterPosition());
//                intent.putExtra("des",prodList.get(i).category);
//
