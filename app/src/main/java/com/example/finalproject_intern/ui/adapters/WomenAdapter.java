...
import com.example.finalproject_intern.ui.productwomenactivety;

import java.util.ArrayList;
import java.util.List;

public class WomenAdapter extends RecyclerView.Adapter<ProductCAstomadapter.MyViewHolder> implements Filterable {
    ...
    public WomenAdapter(Context ctx, List<ProductModel> heroList) {
        this.ctx = ctx;
...
//                .load( "https://api.lorem.space/image/furniture?w=640&h=480&r=9470")
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ctx, productwomenactivety.class);
