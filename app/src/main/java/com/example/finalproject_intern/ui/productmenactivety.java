...
public class productmenactivety extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_productmenactivety);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(productmenactivety.this,Allmenproduct.class));
            }
        });
        ...
        productViewModel.getmensproduct(this).observe(this,productModels -> {
...
//                    Chart.cardofRVS.add(new ProductModel(productModels.get(position)));
                    Intent intent1=new Intent(productmenactivety.this,Chart.class);
