...
public class productwomenactivety extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_productwomenactivety);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(productwomenactivety.this,Allwomenproduct.class));
            }
        });
        ...
        productViewModel.getwomenproduct(this).observe(this,productModels -> {
...
//                    Chart.cardofRVS.add(new ProductModel(productModels.get(position)));
                    Intent intent1=new Intent(productwomenactivety.this,Chart.class);
